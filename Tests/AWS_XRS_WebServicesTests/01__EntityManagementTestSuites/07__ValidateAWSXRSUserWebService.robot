...
Validate AWS XRS Get Users REST Web Services Response Returns 200 OK
  ...
  ${w_slash_response} =  Get Users Response With Forward Slash  &{XRS_AWS_WEBSERVICE_USER_TEST_PARAMS}
  ${wo_slash_response} =  Get Users Response Without Forward Slash  &{XRS_AWS_WEBSERVICE_USER_TEST_PARAMS}
