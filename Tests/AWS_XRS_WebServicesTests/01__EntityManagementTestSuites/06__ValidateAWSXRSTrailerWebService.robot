...
*** Test Cases ***
Validate AWS XRS Get Trailer REST Web Services Response Returns 400 Error
...
Validate AWS XRS Post Trailer REST Web Services Response Returns Code 201
...
Validate AWS XRS Get Trailer REST Web Services Response Returns 200 OK
  [Documentation]  Verifies that a posted trailer now exists
  ${response} =  Get Trailer By ID  ${XRS_WEB_SERVICES_TEST_TRAILER.TrailerIdentity}
  Request Should Be Successful  ${response}

Validate AWS XRS Put Trailer REST Web Services Response Description Returns "Trailer edited successfully."
  [Documentation]  Posts a trailer and expects a Code value of 201
...
Validate AWS XRS Delete Trailer REST Web Services Response Returns 200 OK
...
Validate AWS XRS Get Trailers REST Web Services For All Trailers Response Returns 200 OK
  [Documentation]  Gets all the trailers
  [Tags]  xrsawsperftest
  ${response} =  Get All Trailers
  Request Should Be Successful  ${response}

Validate AWS XRS Delete Trailers REST Web Services Response Description Returns "Trailer not exist."
...
Validate AWS XRS Get Trailer V2 REST Web Services Response Returns 400 Error
...
Validate AWS XRS Post Trailer V2 REST Web Services Response Returns Code 201
...
Validate AWS XRS Delete Trailer V2 REST Web Services Response Returns 200 OK
...
Validate AWS XRS Get Trailers V2 REST Web Services For All Trailers Response Returns 200 OK
