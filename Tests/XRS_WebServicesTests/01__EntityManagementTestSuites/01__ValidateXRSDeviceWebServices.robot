...
Validate XRS Put Device REST Web Services Response Description Returns "Device edited successfully."
  [Documentation]  Posts a device and expects a Code value of 201
  ${response} =  Put Devices  @{XRS_WEBSERVICE_PUT_TEST_DEVICE_LIST}
...
Validate XRS Get Devices REST Web Services Response Returns 200 OK With Raw String URI
  ...
  ${w_slash_question_response} =  Get Devices Raw String URI Response With /? And Parameters ${XRS_WEBSERVICE_DEVICE_TEST_PARAMS_STRING}
  ${w_question_response} =  Get Devices Raw String URI Response With ? And Parameters ${XRS_WEBSERVICE_DEVICE_TEST_PARAMS_STRING}
