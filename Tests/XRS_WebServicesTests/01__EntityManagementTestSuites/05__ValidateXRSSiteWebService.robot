...
Validate XRS Get Sites REST Web Services Response Returns 200 OK
  ...
  ${wo_slash_response} =  Get Sites Response With Forward Slash  &{XRS_WEBSERVICE_SITE_TEST_PARAMS}
  ${w_slash_response} =  Get Sites Response Without Forward Slash  &{XRS_WEBSERVICE_SITE_TEST_PARAMS}
