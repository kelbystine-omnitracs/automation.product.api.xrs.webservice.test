*** Settings ***
Documentation   Fundamental suite to test XRS Critical Events Summary Performance Web Services
...
Suite Setup     Run Keywords
                ...
                ...  AND  Test Data Setup For XRS Critical Events Web Service Test Suite
Suite Teardown  Delete All Sessions
Force Tags      xrsrestwebservicevalidation  xrscriticaleventsrestwebservicevalidation

*** Variables ***

*** Test Cases ***
Validate XRS Get Critical Events Summary With Forward Slash REST Web Services Response Returns 200 OK
  [Documentation]  Get Critical Events Events with basic parameters
  ${w_slash_response} =  Get Critical Events Summary Response With Forward Slash  &{XRS_WEBSERVICE_CRITICAL_EVENTS_TEST_PARAMS}
  Request Should Be Successful  ${w_slash_response}

Validate XRS Get Critical Events Summary Without Forward Slash REST Web Services Response Returns 200 OK
  [Documentation]  Get Critical Events Events with basic parameters
  ${wo_slash_response} =  Get Critical Events Summary Response Without Forward Slash  &{XRS_WEBSERVICE_CRITICAL_EVENTS_TEST_PARAMS}
...
Validate XRS Get Critical Events Summary REST Web Services For All Critical Events Summaries Response Returns 200 OK
...
Validate XRS Get Critical Events Summaries By Driver ID With Forward Slash REST Web Services Response Returns 200 OK
  [Documentation]  Get Critical Events Events By Driver IDwith basic parameters
  ${w_slash_response} =  Get Critical Events Summary By Driver ID Response With Forward Slash  ${SAMPLE_DRIVER_ID_FOR_CRITICAL_EVENTS_TEST}  &{XRS_WEBSERVICE_CRITICAL_EVENTS_TEST_PARAMS}
  Request Should Be Successful  ${w_slash_response}

Validate XRS Get Critical Events Summaries By Driver ID Without Forward Slash REST Web Services Response Returns 200 OK
  [Documentation]  Get Critical Events Events By Driver IDwith basic parameters
  ${wo_slash_response} =  Get Critical Events Summary By Driver ID Response Without Forward Slash  ${SAMPLE_DRIVER_ID_FOR_CRITICAL_EVENTS_TEST}  &{XRS_WEBSERVICE_CRITICAL_EVENTS_TEST_PARAMS}
  Request Should Be Successful  ${wo_slash_response}
...
Validate XRS Get Critical Events Summary By Driver ID REST Web Services For All Critical Events Summaries Response Returns 200 OK
...
Validate XRS Get Critical Events Summaries By Vehicle ID With Forward Slash REST Web Services Response Returns 200 OK
  [Documentation]  Get Critical Events Events By Vehicle ID with basic parameters
  ${w_slash_response} =  Get Critical Events Summary By Vehicle ID Response With Forward Slash  ${SAMPLE_VEHICLE_ID_FOR_CRITICAL_EVENTS_TEST}  &{XRS_WEBSERVICE_CRITICAL_EVENTS_TEST_PARAMS}
  Request Should Be Successful  ${w_slash_response}

Validate XRS Get Critical Events Summaries By Vehicle ID Without Forward Slash REST Web Services Response Returns 200 OK
  [Documentation]  Get Critical Events Events By Vehicle ID with basic parameters
  ${wo_slash_response} =  Get Critical Events Summary By Vehicle ID Response Without Forward Slash  ${SAMPLE_VEHICLE_ID_FOR_CRITICAL_EVENTS_TEST}  &{XRS_WEBSERVICE_CRITICAL_EVENTS_TEST_PARAMS}
  Request Should Be Successful  ${wo_slash_response}

Validate XRS Get Critical Events Summary By Vehicle ID With Raw String URI And /? REST Web Services Response Returns 200 OK
  [Documentation]  Get Critical Events Events By Vehicle ID with basic parameters using a raw URI string
  &{test_data} =  Create Dictionary  vehicle_id=${SAMPLE_VEHICLE_ID_FOR_CRITICAL_EVENTS_TEST}  params_string=${XRS_WEBSERVICE_CRITICAL_EVENTS_TEST_PARAMS_STRING}
...
Validate XRS Get Critical Events Summary By Vehicle ID REST Web Services For All Critical Events Summaries Response Returns 200 OK
...
*** Keywords ***
Test Data Setup For XRS Critical Events Web Service Test Suite
  [Documentation]  Keyword for setting up suite variables for Critical Events Web Service Tests.
  ...
  # Create test params
  &{XRS_WEBSERVICE_CRITICAL_EVENTS_TEST_PARAMS} =  Create Dictionary
  ...  OrganizationID=${XRS_GENERAL_INFORMATION.Company.Company_ID}
  ...  IncludeHistory=True
  ...  OrderDirection=Ascending
  Set Suite Variable  &{XRS_WEBSERVICE_CRITICAL_EVENTS_TEST_PARAMS}
  # Create test params string
  ${XRS_WEBSERVICE_CRITICAL_EVENTS_TEST_PARAMS_STRING} =  Catenate  SEPARATOR=&
  ...  OrganizationID=${XRS_WEBSERVICE_CRITICAL_EVENTS_TEST_PARAMS.OrganizationID}
  ...  IncludeHistory=${XRS_WEBSERVICE_CRITICAL_EVENTS_TEST_PARAMS.IncludeHistory}
  ...  OrderDirection=${XRS_WEBSERVICE_CRITICAL_EVENTS_TEST_PARAMS.OrderDirection}
  Set Suite Variable  ${XRS_WEBSERVICE_CRITICAL_EVENTS_TEST_PARAMS_STRING}
