...
Validate AWS XRS Post Device REST Web Services Response Returns Code 201
  ...
  Verify Post Device Method Returns Code 201 @{XRS_AWS_WEBSERVICE_POST_TEST_DEVICE_LIST}
...
Validate AWS XRS Put Device REST Web Services Response Description Returns "Device edited successfully."
  [Documentation]  Posts a device and expects a Code value of 201
  Verify Put Device @{XRS_AWS_WEBSERVICE_PUT_TEST_DEVICE_LIST} Description Returns "Device edited successfully."

Validate AWS XRS Get Devices With Forward Slash REST Web Services Response Returns 200 OK
  [Documentation]  Get devices with basic parameters and URI ends with a forward slash before parameters
  Verify Get Devices With Parameters &{XRS_AWS_WEBSERVICE_DEVICE_TEST_PARAMS} Method Is Successful With Forward Slash

Validate AWS XRS Get Devices Without Forward Slash REST Web Services Response Returns 200 OK
  [Documentation]  Get devices with basic parameters and URI ends without a forward slash before parameters
  Verify Get Devices With Parameters &{XRS_AWS_WEBSERVICE_DEVICE_TEST_PARAMS} Method Is Successful Without Forward Slash
...
Validate AWS XRS Get Devices With Raw String URI And /? REST Web Services Response Returns 200 OK
  ...
  Verify Get Devices Raw String ${XRS_AWS_WEBSERVICE_DEVICE_TEST_PARAMS_STRING} With /? Is Successful
