...
*** Test Cases ***
Validate XRS Get Black Box Summary REST Web Services Response Returns 200 OK
...
Validate XRS Get Black Box Summary REST Web Services Response Returns 200 OK With Raw String URI
...
Validate XRS Get Black Box Summaries By Driver ID REST Web Services Response Returns 200 OK
...
Validate XRS Get Black Box Summary By Driver ID REST Web Services Response Returns 200 OK With Raw String URI
...
Validate XRS Get Black Box Summaries By Vehicle ID REST Web Services Response Returns 200 OK
...
Validate XRS Get Black Box Summary By Vehicle ID REST Web Services Response Returns 200 OK With Raw String URI
